...
function Home() {
  ...
  <span style={{ fontSize: "2.5rem", fontWeight: "bold" ,
    fontFamily: "'Vollkorn', serif" }}>CampusFix</span>
</div>
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p>Integrated platform for facility management, student services, and campus engagement.</p>
      ...
      <section id="services" className="maintenance">
        ...
        <div className="services-grid">
          <div className="service-card">
            <img src="https://tridentairnc.com/wp-content/uploads/2025/01/Plumbing-10.jpeg" alt="Plumbing"/>
            <div className="service-card-content">
              <h3>Plumbing Services</h3>
              <p>24/7 emergency pipe repairs, leak fixes, and drainage solutions.</p>
              <button className="btn-primary">Report Issue</button>
            </div>
          </div>
          <div className="service-card">
            <img src="https://www.snellheatingandair.com/wp-content/uploads/Electrical-Services-Technician-Snell-Image.jpg" alt="Electrical"/>
            <div className="service-card-content">
              <h3>Electrical Repairs</h3>
              <p>Quick response for wiring issues, power outages, and appliance repairs.</p>
              <button className="btn-primary">Report Issue</button>
            </div>
          </div>
          <div className="service-card">
            <img src="https://carpentry-services-dubai.com/wp-content/uploads/doors-installation-repairing/Door-Repairing-Carpenter-Villa-Main-Entrance-Door-installation-Replace.webp" alt="Carpentry"/>
            <div className="service-card-content">
              <h3>Carpentry Services</h3>
              <p>Furniture repairs, door/window fixes, and custom installations.</p>
              <button className="btn-primary">Report Issue</button>
            </div>
          </div>
        </div>
...
>
  ...
  >
    ...
    <div>
      ...
      <p style={{ marginBottom: "1.5rem", lineHeight: "1.7" }}>
        ...
        streamline student life and administrative operations. Our mission is
        to bridge the gap between students and campus services through
  ...
  <div className="footer-content">
    ...
    <div className="footer-section">
      ...
      <div className="developer-info">
        ...
        <a href="https://www.linkedin.com/in/tharun-budidha" 
           target="_blank" 
           rel="noopener noreferrer"
           className="developer-link" style={{color:"white"}} >
          <i className="fab fa-linkedin" style={{color:"white"}}></i> Portfolio & Experience
        </a>
      </div>
    </div>
    ...
    <div className="footer-section">
      ...
      <div className="social-links">
        <a href="https://www.linkedin.com/in/tharun-budidha" aria-label="Linkedin">Linkedin</a>
  ...
  <div className="footer-bottom">
    ...
    <p className="credits">Crafted with <span className="heart">❤️</span> by Tharun Budidha</p>
  </div>
</footer>
    </div>
  );
